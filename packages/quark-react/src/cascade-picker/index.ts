...
import {Props, CustomEvent, PickerColumn, SelectedColumn} from 'quarkd/lib/cascadepicker'
import { componentBaseInterface, ReactifyProps } from '../type';

type CascadePickerProps = componentBaseInterface & ReactifyProps<Props, CustomEvent>;
