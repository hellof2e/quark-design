...
function getInfoFromPackage() {
    ...
    // 读取 Quark 版本
    const libVersion = packageInfo['dependencies']['quark'] || packageInfo['dependencies']['quark-react'] ||'Undefined';
    // 获取技术栈
    const isVue = packageInfo['dependencies']['vue'] || false
    
    return {
        appName,
        libVersion,
        techStack: isVue ? 'vue' : 'react',
        appDesc: "desc",
    }
}
