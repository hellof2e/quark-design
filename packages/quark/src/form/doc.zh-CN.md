...
```html
 <quark-form ref="form3">
      <quark-field placeholder="请输入文本" name="field" label="年龄"  :value="field"></quark-field>
      <div class="line" />
      <div class="form-item">
      ...
      <div class="form-item">
        <span>蔬菜:</span>
        <quark-checkbox name="checkbox1" shape="square" :checked="checkbox1" >黄瓜</quark-checkbox>
        <quark-checkbox name="checkbox2" shape="square" :checked="checkbox2" >生姜</quark-checkbox>
      </div>
      <div class="line" />
      <div class="form-item">
        <span>水果:</span>
      ...
      <div class="form-item">
        ...
        <quark-picker title="请选择时间" ref="pickerRef" :open="open" @close="close" @confirm="confirm" name="picker" />
      </div>
      <div class="line" />
      <div class="submit-wrap">
