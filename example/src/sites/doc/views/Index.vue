...
export default defineComponent({
  ...
  setup() {
    ...
    const watchDemoUrl = (router: RouteLocationNormalized) => {
      ...
      let url = `${origin}${pathname}demo.html#${router.path.toLocaleLowerCase().split('/').pop()}?lang=${localStorage.getItem("language")}`;
      data.demoUrl = url;
    };
    ...
    const componentTitle = (to?: any) => {
      ...
      state.componentName.name = routename.indexOf('-react') ? routename.split('-').shift() : routename;
      nav.forEach((i: any) => {
